...
module.exports = function (fileInfo, api, options) {
  ...
  const yogaPathsMap = options.yogaPathsMap;

  const convertToYogaPath = (path) => yogaPathsMap[path] || "'@file'";
  ...
  getFirst().node.comments = [
    j.commentLine(
      ` @generated by "./gentest/run.js" from "${convertToYogaPath(fileInfo.path)}"\n`
    ),
  ];
