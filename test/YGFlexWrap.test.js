// @generated by "./gentest/run.js" from "../yoga/javascript/tests/Facebook.Yoga/YGFlexWrapTest.js"
...
it("wrap_row", function () {
  ...
  try {
    ...
    expect(
      root.getComputedHeight(),
      "60 === root.getComputedHeight() (" + root.getComputedHeight() + ")"
    ).toBe(60);;
...
it("flex_wrap_align_stretch_fits_one_row", function () {
  ...
  try {
    ...
    expect(
      root.getComputedWidth(),
      "150 === root.getComputedWidth() (" + root.getComputedWidth() + ")"
    ).toBe(150);;
    expect(
      root.getComputedHeight(),
      "100 === root.getComputedHeight() (" + root.getComputedHeight() + ")"
...
it("wrap_reverse_row_align_content_flex_start", function () {
  ...
  try {
    ...
    expect(
      root.getComputedHeight(),
      "80 === root.getComputedHeight() (" + root.getComputedHeight() + ")"
    ).toBe(80);;
...
it("wrapped_column_max_height", function () {
  ...
  try {
    ...
    expect(
      root.getComputedWidth(),
      "700 === root.getComputedWidth() (" + root.getComputedWidth() + ")"
    ).toBe(700);;
    expect(
      root.getComputedHeight(),
