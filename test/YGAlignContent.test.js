// @generated by "./gentest/run.js" from "../yoga/javascript/tests/Facebook.Yoga/YGAlignContentTest.js"
...
it("align_content_flex_start", function () {
  ...
  try {
    ...
    expect(
      ...
      "130 === root.getComputedWidth() (" + root.getComputedWidth() + ")"
    ).toBe(130);;
    expect(
...
it("align_content_flex_start_with_flex", function () {
  ...
  try {
    ...
    expect(
      root.getComputedHeight(),
      "120 === root.getComputedHeight() (" + root.getComputedHeight() + ")"
    ).toBe(120);;
...
it("align_content_spacearound", function () {
  ...
  try {
    ...
    expect(
      root.getComputedWidth(),
      "140 === root.getComputedWidth() (" + root.getComputedWidth() + ")"
    ).toBe(140);;
    expect(
      root.getComputedHeight(),
      "120 === root.getComputedHeight() (" + root.getComputedHeight() + ")"
...
it("align_content_stretch_column", function () {
  ...
  try {
    ...
    expect(
      root.getComputedHeight(),
      "150 === root.getComputedHeight() (" + root.getComputedHeight() + ")"
    ).toBe(150);;
