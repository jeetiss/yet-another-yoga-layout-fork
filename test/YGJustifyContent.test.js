// @generated by "./gentest/run.js" from "../yoga/javascript/tests/Facebook.Yoga/YGJustifyContentTest.js"
...
it("justify_content_row_flex_start", function () {
  ...
  try {
    ...
    expect(
      ...
      "102 === root.getComputedWidth() (" + root.getComputedWidth() + ")"
    ).toBe(102);;
    expect(
      root.getComputedHeight(),
      "102 === root.getComputedHeight() (" + root.getComputedHeight() + ")"
    ).toBe(102);;
...
it("justify_content_row_min_width_and_margin", function () {
  ...
  try {
    ...
    expect(
      root.getComputedLeft(),
      "100 === root.getComputedLeft() (" + root.getComputedLeft() + ")"
    ).toBe(100);;
    expect(
      root.getComputedTop(),
      "0 === root.getComputedTop() (" + root.getComputedTop() + ")"
...
it("justify_content_column_min_height_and_margin", function () {
  ...
  try {
    ...
    expect(
      root.getComputedTop(),
      "100 === root.getComputedTop() (" + root.getComputedTop() + ")"
    ).toBe(100);;
    expect(
      root.getComputedWidth(),
...
it("justify_content_min_width_with_padding_child_width_greater_than_parent", function () {
  ...
  try {
    ...
    expect(
      root.getComputedWidth(),
      "1000 === root.getComputedWidth() (" + root.getComputedWidth() + ")"
    ).toBe(1000);;
    expect(
      root.getComputedHeight(),
      "1584 === root.getComputedHeight() (" + root.getComputedHeight() + ")"
    ).toBe(1584);;
