// @generated by "./gentest/run.js" from "../yoga/javascript/tests/Facebook.Yoga/YGAlignItemsTest.js"
...
it("align_center_should_size_based_on_content", function () {
  ...
  try {
    ...
    expect(
      root.getComputedTop(),
      "20 === root.getComputedTop() (" + root.getComputedTop() + ")"
    ).toBe(20);;
    expect(
      root.getComputedWidth(),
      "100 === root.getComputedWidth() (" + root.getComputedWidth() + ")"
